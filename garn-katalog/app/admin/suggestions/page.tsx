...
import { ModerationClient } from '@/components/substitutions/ModerationClient'
...
export default async function SuggestionsModerationPage() {
  ...
  return (
    <div>
      <h1 className="font-serif text-3xl text-forest mb-2">Moderation: eksterne forslag</h1>
